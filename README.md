...
* [Update Salary](docs/instructor/update-salary.md) : `PUT /api/instructors/update-salary`
* [Show Instructor Logger](docs/instructor/show-instructor-logger-by-instructor-id.md) : `GET /api/instructor/instructorLoggerByInstructorId`
* [Show Instructor Logger](docs/instructor/show-instructor-logger-by-date.md) : `GET /api/instructor/instructorLoggerByDate`
...
Project Link: [https://github.com/113-GittiGidiyor-Java-Spring-Bootcamp/fifth-homework-emredalci](https://github.com/113-GittiGidiyor-Java-Spring-Bootcamp/fifth-homework-emredalci)